...
function startScreen(rerender, navigate) {
  ...
  return shell(rerender, navigate, {
    ...
    lede: 'Your private library stays on Spark. Review a reply and choose Send reply whenever you are ready.',
    body: el('div', { class: 'stack' }, [
      ...
      el('ul', { class: 'ob-points' }, [
        ...
        el('li', { text: 'Nemotron on Spark does the thinking for your private library.' }),
