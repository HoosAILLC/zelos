...
export function automaticBackupPanel(){
  ...
  return el('div',{class:'automatic-backup-panel'},[el('h3',{text:'Daily encrypted backups'}),
    ...
    el('p',{class:'quiet-note',text:'Keeps the latest seven copies on the computer running Zelos, including saved records and connection settings. The recovery key stays separately on that computer. Keep a copy on another device to protect against losing this computer.'}),message,run]);
}
