...
export function mailPreferencesPanel(onChange=()=>{}) {
  ...
  function render(data){
    ...
    panel.replaceChildren(...[el('label',{class:'mail-auto-toggle'},[auto,el('strong',{text:'Prepare replies automatically'})]),
      el('p',{class:'quiet-note',text:'During your regular checks, your AI prepares replies to recent important emails that ask for an answer. Existing drafts stay yours. Sending always waits for you.'}),
